// May 2017 - Lucas Marques
// AMBOTS Displacement Measuring
// Fine Tunning the PMW3360 Optical Sensor
...
#define OPTICAL_CALIBRATION_RATIO 43.89  // Ratio = (resolution/25.4mm) // example: the ratio for 1000 dpi will be (1000/25.4) = 39.37.
...
void loop() {
  update_coordinates(); // request a new reading
  // print the current X-Y coordinates in relation to the origin
  Serial.print("X: ");
